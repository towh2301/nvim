...
-- =============================
-- Note: These only work when in a Rust buffer with rustaceanvim enabled

-- Open Cargo.toml from any Rust file
keymap.set("n", "<leader>rc", ":RustOpenCargo<CR>", { noremap = true, silent = true, desc = "Open Cargo.toml" })

-- Hover actions / Show documentation
keymap.set("n", "<leader>rh", ":RustHoverActions<CR>", { noremap = true, silent = true, desc = "Rust hover actions" })

-- Code actions
keymap.set("n", "<leader>ra", ":RustCodeAction<CR>", { noremap = true, silent = true, desc = "Rust code action" })

-- Debug
keymap.set("n", "<leader>rd", ":RustDebugable<CR>", { noremap = true, silent = true, desc = "Run Rust debuggable" })

-- Run with cargo
keymap.set("n", "<leader>rr", ":RustRun<CR>", { noremap = true, silent = true, desc = "Run Rust project" })

-- Format document
keymap.set("n", "<leader>rf", ":RustFmt<CR>", { noremap = true, silent = true, desc = "Format Rust code" })

-- Expand macros
keymap.set("n", "<leader>rm", ":RustExpandMacro<CR>", { noremap = true, silent = true, desc = "Expand Rust macro" })
